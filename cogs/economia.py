...
class Econimia(commands.Cog):
    ...
    @app_command.command(name="saldo", description="veja o seu saldo na conta do bot")
    ...
    @app_command.command(name="add", description="Adiciona moedas a um usuário (Apenas Admins)")
