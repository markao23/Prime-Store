...
class Econimia(commands.Cog):
    ...
    @app_commands.command(name="saldo", description="veja o seu saldo na conta do bot")
    ...
    @app_commands.command(name="add", description="Adiciona moedas a um usuário (Apenas Admins)")
